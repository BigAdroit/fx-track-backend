...
async function sendVerificationMail(user, callback) {
    ...
    let transporter = nodemailer.createTransport({
        ...
        pass: process.env.MAIL_KEY_STRING
  }
    })
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                    ...
                                                    <div class="space-y-3">
                                                      <p class="text-gray-700 rubik" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; font-family: 'Rubik', sans-serif; font-weight: bold; margin: 0;" align="left"> Hello Ayeni, </p>
...
module.exports = sendVerificationMail(user, callback)